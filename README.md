...
| 02/18 | Filtering and Orthology detection  | HAL 2.2; Optional HAL 2.4 | You will know about the different filtering and orthology inference methods | [lecture6.md](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture6.md) | 1) Read [Nichio2017](https://www.frontiersin.org/articles/10.3389/fgene.2017.00165/full); 2) Choose one orthology detection method, read its paper and run it on your data (git commit) | 03/09 |
