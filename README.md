...
| 02/04 | Continue with reproducibility | Have [git](https://happygitwithr.com/install-git.html) installed | | | [Git HW](https://github.com/crsl4/phylogenetics-class/tree/master/exercises/git-hw.md) | 
