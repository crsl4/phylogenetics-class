...
## Main topics:
- Introduction to tree thinking skills
- Introduction to reproducible scripting and programming
- Short summary of statistical inference topics (likelihood, bayesian, optimization in tree space)
- Sequence alignment, filtering, orthology
- Models of molecular evolution
- Likelihood based methods
- Introduction to the coalescent model; species tree/network methods
