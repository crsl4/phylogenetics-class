...
| Session | Topic | Reading before class | At the end of the session | Lecture notes | Homework |
| :---:   | :---: | :---:       | :---:                     | :---: | :---: |
...
| 02/16 | Continue with alignment | One paper assigned per student: 1) [ClustalW](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC308517/), 2) [MUSCLE](https://academic.oup.com/nar/article/32/5/1792/2380623), 3) [T-Coffee](https://www.sciencedirect.com/science/article/pii/S0022283600940427); Optional: HAl 2.2 | | | 1) Read [Alignathon paper](https://genome.cshlp.org/content/24/12/2077) and do [quiz](); 2) Choose and run an alignment method for your data |
| 02/18 | Orthology detection  | HAL 2.4 and [quiz](); read [Nichio2017](https://www.frontiersin.org/articles/10.3389/fgene.2017.00165/full) | You will know about the different orthology inference methods | [lecture6.md](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture6.md) | Choose one orthology detection method and read its paper | 
...
| 02/25 | Distance and parsimony methods  | [Install R](https://cloud.r-project.org/) and optional readings: HB Ch 5-6, Baum Ch 7-8 | You will be able to explain both algorithms to reconstruct trees: 1) based on distances and 2) based on parsimony | [lecture8.md](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture8.md) | Run distance and parsimony methods on your own data | 
| 03/02 | Continue with distance and parsimony methods | | | | | 
...
| 03/30 | Continue Bayesian inference | | | | | 
...
| 04/06 | Model selection: Guest lecture by [Rob Lanfear](http://www.robertlanfear.com/)  | | | | |
 Continuing with Bayesian inference | | | |
| 04/08 | The coalescent  | HAL 3.1 and [quiz](), 3.3 and [quiz]() | You will be able to explain the coalescent model for species trees and networks | [lecture14.pdf](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture14.pdf) | |
 Continue with the coalescent (and 1-min presentation of students' project data/goal) | Create a slide describing your data [here](https://docs.google.com/presentation/d/1-DRevm_ntBOD6F5PMnQkzbMuhSiJMjjaBiD8FvUhfY4/edit?usp=sharing) | | |
...
| 05/06 | What else is out there? | Read [Jermiin2020](https://academic.oup.com/nargab/article/2/2/lqaa041/5861483) | You will hear a brief overview of topics not covered in this class and will have access to resources to learn more | |
