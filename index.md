...
| 02/02 | Alignment (Part 1) |  | You will be able to explain the most widely used algorithms for multiple sequence alignment | [lecture5.md](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture5.md) | [Learn@Home: Sequencing](https://github.com/crsl4/phylogenetics-class/tree/master/lecture-notes/lecture4-learn-home.md) (due 02/09) |
| 02/07 | Alignment (Part 2) | | | [lecture5-2.md](https://github.com/crsl4/phylogenetics-class/blob/master/lecture-notes/lecture5-2.md) | [Needleman-Wunsch HW](https://github.com/crsl4/phylogenetics-class/blob/master/exercises/needleman-hw.md) and canvas quiz (due 02/14) |
| 02/07 | HW due: [Reproducibility](https://github.com/crsl4/phylogenetics-class/tree/master/exercises/git-hw.md) | | | | |
