...
Research report and reproducible script can be submitted late (exact date in canvas), but they lose 20% of available points. That is, final research report is worth 50 points if turned in on time, but only 40 points if turned in late.
